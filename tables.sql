...
UPDATE highway SET no_of_roads = 24 ;
UPDATE highway SET no_of_roads = 28 WHERE serial_no = 1 ;
UPDATE highway SET no_of_roads = 17 WHERE serial_no = 17 AND name_of_highway = 'NH 75';
